...
/**
 * Same items/destination shape as QuoteCheckoutRequest — this only lists
 * available couriers for "Ekspedisi" (RajaOngkir), it never prices or
 * creates anything.
 */
class CourierOptionsRequest extends BaseFormRequest
{
